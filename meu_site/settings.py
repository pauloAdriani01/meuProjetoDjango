...
SECRET_KEY = 'django-insecure-b*(*#4g6nkdssij0zwp@8qrqnkp+t@(fc$5cb&%e4-=)32)_au'
...
# Diretório onde os arquivos estáticos serão coletados para produção (site em funcionamento)
STATIC_ROOT = BASE_DIR / 'arquivos_producao'
